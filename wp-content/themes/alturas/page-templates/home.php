...
<div class="landing">
  ...
  <div class="slider fade1">
    ...
    <a href="<?php echo get_permalink($post_id_left); ?>"><div class="landing-background-image homepage-landing-image" style="background: url(<?php echo $background_left['0']?>) no-repeat 50% 50%; background-size:cover">
  ...
  <div class="slider fade2">
    ...
    <a href="<?php echo get_permalink($post_id_right); ?>"><div class="landing-background-image" style="background: url(<?php echo $background_right['0']?>) no-repeat 50% 50%; background-size:cover">
      <div class="image-content-wrapper">
